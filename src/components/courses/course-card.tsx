...
export function CourseCard({
    ...
    return (
        <div className="group bg-[var(--color-surface-container-lowest)] rounded-[var(--radius-3xl)] overflow-hidden coral-shadow border border-[var(--color-border)] hover:-translate-y-2 transition-all duration-300 flex flex-col justify-between">
            {/* Cover */}
