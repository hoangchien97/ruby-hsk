            ...
            <div className="max-w-4xl w-full flex flex-col md:flex-row items-center gap-12 relative z-10">
                ...
                <div className="flex-grow text-center md:text-left">
                    <span className="inline-block px-4 py-1.5 rounded-full bg-[var(--color-primary)]/10 text-[var(--color-primary)] font-bold text-label-lg mb-6">
                        {isVi ? 'Lỗi 404' : 'Error 404'}
                    </span>
                    <h1 className="text-display-lg md:text-[40px] leading-tight text-[var(--color-on-surface)] mb-4">
                        {isVi ? 'Ối! Ruby không tìm thấy bài học này.' : 'Oops! Ruby can\'t find this lesson.'}
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                        <Link href="/">
                            <Button className="w-full sm:w-auto inline-flex items-center justify-center gap-2">
                                <Home className="w-4.5 h-4.5" /> {isVi ? 'Về trang chủ' : 'Back Home'}
                            </Button>
                        </Link>
                        <Button
                            variant="secondary"
                        ...
                        >
                            <ArrowLeft className="w-4.5 h-4.5" /> {isVi ? 'Quay lại' : 'Go Back'}
                        </Button>
                    </div>
                    ...
                    <div className="mt-10 grid grid-cols-2 gap-4">
                        ...
                        >
                            ...
                            <span className="text-label-sm font-bold text-[var(--color-on-surface)]">
                                {isVi ? 'Từ vựng & Khóa học' : 'Courses & Vocab'}
                            </span>
                        </Link>
                        <Link
                            href="/about"
                        ...
                        >
                            ...
                            <span className="text-label-sm font-bold text-[var(--color-on-surface)]">
                                {isVi ? 'Luyện thi cùng cô Ngọc' : 'About Ms. Ngoc'}
                            </span>
                        </Link>
                    </div>
                </div>
