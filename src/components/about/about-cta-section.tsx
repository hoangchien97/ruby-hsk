  ...
  return (
    <section className="app-section">
      <div className="app-container">
        <div className="p-8 md:p-16 rounded-[var(--radius-3xl)] bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-primary-container)] border border-[var(--color-primary)]/20 shadow-[var(--shadow-coral)] overflow-hidden relative text-center">
