...
export function LogoIcon({className = 'h-10 w-10'}: {className?: string}) {
  return (
    <div className={`relative inline-flex items-center justify-center rounded-2xl bg-[var(--color-primary-fixed)] text-[var(--color-primary)] shadow-sm ${className}`} aria-label="Ruby HSK logo">
