      ...
      <div className="app-container">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {METHODS.map(({ key, icon }) => (
            <div
              key={key}
              className="p-8 rounded-[var(--radius-3xl)] bg-[var(--color-surface-container-lowest)] border border-[var(--color-surface-variant)] shadow-[var(--shadow-soft)] hover:shadow-[var(--shadow-coral)] hover:-translate-y-1 transition-all duration-300"
            >
