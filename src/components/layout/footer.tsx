...
export function Footer() {
  ...
  const communityLinks = [
    { label: tNav('about'), href: NavLinks.about },
    { label: t('linkReviews'), href: NavLinks.about },
    { label: t('linkContact'), href: NavLinks.contact },
  ];

  const supportLinks = [
    { label: tNav('privacy'), href: NavLinks.privacy },
    { label: tNav('terms'), href: NavLinks.terms },
    { label: tNav('contact'), href: NavLinks.contact },
  ];
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-12">
        <div className="flex flex-col justify-between gap-12 md:flex-row">
          ...
          <div className="grid grid-cols-2 gap-10 sm:grid-cols-3 md:gap-20">
            <FooterGroup title={t('groupStudy')} links={studyLinks} />
            <FooterGroup title={t('groupCommunity')} links={communityLinks} />
            <FooterGroup title={t('groupSupport')} links={supportLinks} />
          </div>
        </div>
